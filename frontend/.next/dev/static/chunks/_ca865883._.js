    ...
    const dashboardMetricsMemo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardOverview.useMemo[dashboardMetricsMemo]": ()=>{
            ...
            const totalTables = pipelinesArray.reduce({
                "DashboardOverview.useMemo[dashboardMetricsMemo].totalTables": (sum, p)=>sum + (p.table_mappings?.length || 0)
    ...
    const chartDataMemo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardOverview.useMemo[chartDataMemo]": ()=>{
            ...
            if (metricsArray.length === 0) {
                ...
                const chartDataPoints = days.map({
                    "DashboardOverview.useMemo[chartDataMemo].chartDataPoints": (day, idx)=>{
                        const dayStart = new Date(day);
                        dayStart.setHours(0, 0, 0, 0);
                        const dayEnd = new Date(day);
                        dayEnd.setHours(23, 59, 59, 999);
                        const dayEvents = eventsArray.filter({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints.dayEvents": (e)=>{
                                try {
                        ...
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints.dayEvents"]);
                        const replicated = dayEvents.length;
                        const synced = dayEvents.filter({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints": (e)=>e.status === 'applied' || e.status === 'success'
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints"]).length;
                        const errors = dayEvents.filter({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints": (e)=>e.status === 'failed' || e.status === 'error'
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints"]).length;
                ...
                }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints"]);
                ...
                const chartDataPoints = days.map({
                    "DashboardOverview.useMemo[chartDataMemo].chartDataPoints": (dayDate, idx)=>{
                        // Find metrics for this day
                        const dayMetrics = metricsArray.filter({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints.dayMetrics": (m)=>{
                                try {
                        ...
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints.dayMetrics"]);
                        // Aggregate metrics for the day
                        const totalEvents = dayMetrics.reduce({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints.totalEvents": (sum, m)=>sum + (m.total_events || 0)
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints.totalEvents"], 0);
                        const totalErrors = dayMetrics.reduce({
                            "DashboardOverview.useMemo[chartDataMemo].chartDataPoints.totalErrors": (sum, m)=>sum + (m.error_count || 0)
                        }["DashboardOverview.useMemo[chartDataMemo].chartDataPoints.totalErrors"], 0);
        ...
        "DashboardOverview.useMemo[recentActivity]": ()=>{
            ...
            recentEvents.forEach({
                "DashboardOverview.useMemo[recentActivity]": (event)=>{
                    ...
                    const pipeline = pipelinesArray.find({
                        "DashboardOverview.useMemo[recentActivity].pipeline": (p)=>{
                            const pId = String(p.id);
                            const eId = String(event.pipeline_id);
                            return pId === eId || pId === String(Number(eId)) || String(Number(pId)) === eId;
                        }
                    }["DashboardOverview.useMemo[recentActivity].pipeline"]);
                    if (pipeline) {
                        ...
                        if (!activityMap.has(pipelineKey)) {
                            try {
                                activityMap.set(pipelineKey, {
                                    ...
                                    time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(event.created_at), {
                                        addSuffix: true
                                    }),
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: [
                    ...
                    isLoading && (events.length === 0 || recentActivity.length === 0) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardOverview, "6SvVFxr4bD0V1NzKYbyOTno0Ync=", false, function() {
    return [
...
//# sourceMappingURL=_ca865883._.js.map