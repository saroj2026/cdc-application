...
function MonitoringPage() {
    ...
    const userSelectedAllRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MonitoringPage.useEffect": ()=>{
            ...
            }["MonitoringPage.useEffect.interval"], 5000);
            return ({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MonitoringPage.useEffect": ()=>{
            if (!isAuthenticated || !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wsClient"].isConnected()) return;
            if (selectedPipelineId) {
                ...
                return ({
                    "MonitoringPage.useEffect": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wsClient"].unsubscribePipeline(pipelineId)
                })["MonitoringPage.useEffect"];
            } else {
                ...
                if (pipelinesArray.length > 0) {
                    const pipelineIds = pipelinesArray.filter({
                        ...
                        "MonitoringPage.useEffect.pipelineIds": (p)=>!isNaN(Number(p.id)) ? Number(p.id) : String(p.id)
                    }["MonitoringPage.useEffect.pipelineIds"]);
                    pipelineIds.forEach({
                        "MonitoringPage.useEffect": (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wsClient"].subscribePipeline(id)
                    }["MonitoringPage.useEffect"]);
                    return ({
                        "MonitoringPage.useEffect": ()=>pipelineIds.forEach({
                                "MonitoringPage.useEffect": (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wsClient"].unsubscribePipeline(id)
                            }["MonitoringPage.useEffect"])
                    })["MonitoringPage.useEffect"];
                }
            }
        ...
        selectedPipelineId,
        pipelines,
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wsClient"]
    ]);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonitoringPage.useMemo[chartData]": ()=>{
            ...
            const buckets = Array.from({
                ...
                "MonitoringPage.useMemo[chartData].buckets": (_, i)=>{
                    const bucketTime = new Date(now.getTime() - (11 - i) * 5 * 60 * 1000);
                    return bucketTime;
                }
            }["MonitoringPage.useMemo[chartData].buckets"]);
            return buckets.map({
                "MonitoringPage.useMemo[chartData]": (bucket)=>{
                    const bucketStart = new Date(bucket);
                    const bucketEnd = new Date(bucket.getTime() + 5 * 60 * 1000);
                    const bucketEvents = eventsArray.filter({
                        "MonitoringPage.useMemo[chartData].bucketEvents": (e)=>{
                            try {
                    ...
                    }["MonitoringPage.useMemo[chartData].bucketEvents"]);
                    return {
                        ...
                        latency: bucketEvents.reduce({
                            "MonitoringPage.useMemo[chartData]": (sum, e)=>sum + (e.processing_time_ms || 0)
                        }["MonitoringPage.useMemo[chartData]"], 0) / (bucketEvents.length || 1)
                    };
                }
            }["MonitoringPage.useMemo[chartData]"]);
        }
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonitoringPage.useMemo[stats]": ()=>{
            const totalEvents = filteredEvents.length;
            const appliedEvents = filteredEvents.filter({
                "MonitoringPage.useMemo[stats]": (e)=>e.status === 'applied' || e.status === 'success'
            }["MonitoringPage.useMemo[stats]"]).length;
            const pendingEvents = filteredEvents.filter({
                "MonitoringPage.useMemo[stats]": (e)=>e.status === 'captured' || e.status === 'pending'
            }["MonitoringPage.useMemo[stats]"]).length;
            const failedEvents = filteredEvents.filter({
                "MonitoringPage.useMemo[stats]": (e)=>e.status === 'failed' || e.status === 'error'
            }["MonitoringPage.useMemo[stats]"]).length;
            // Calculate average latency
            const eventsWithLatency = filteredEvents.filter({
                "MonitoringPage.useMemo[stats].eventsWithLatency": (e)=>typeof e.processing_time_ms === 'number'
            }["MonitoringPage.useMemo[stats].eventsWithLatency"]);
            const avgLatency = eventsWithLatency.length > 0 ? Math.round(eventsWithLatency.reduce({
                "MonitoringPage.useMemo[stats]": (sum, e)=>sum + (e.processing_time_ms || 0)
            }["MonitoringPage.useMemo[stats]"], 0) / eventsWithLatency.length) : 0;
            return {
                totalEvents,
                appliedEvents,
                pendingEvents,
    ...
    const handleRefresh = ()=>{
        ...
        Promise.all([
            ...
            pipelineId ? dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$monitoringSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMonitoringMetrics"])({
                pipelineId
            })) : Promise.resolve()
        ]).finally(()=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                ...
                                onValueChange: (value)=>{
                                    if (value === "all") {
                                        ...
                                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$monitoringSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSelectedPipeline"])(id));
                                    }
                                },
                                children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        wsConnected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        stats.failedEvents > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: paginatedEvents.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: event.created_at ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(event.created_at), {
                                                                    addSuffix: true
                                                                }) : 'just now'
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/monitoring/page.tsx",
...
_s(MonitoringPage, "AhmlYGjzDkuzC81e/2nTPHdxJLc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
