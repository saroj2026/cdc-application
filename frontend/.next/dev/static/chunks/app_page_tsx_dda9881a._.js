...
function Home() {
    ...
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "Home.useAppSelector": (state)=>state.auth
    }["Home.useAppSelector"]);
...
_s(Home, "jLOh/oEO6Ke5Ft6cALuMCSPifTA=", false, function() {
    return [
