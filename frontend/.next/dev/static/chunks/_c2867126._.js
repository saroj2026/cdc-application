    ...
    constructor(){
        ...
        this.client.interceptors.response.use((response)=>response, (error)=>{
            ...
            if (error.code === 'ECONNABORTED' || error.message?.includes('timeout')) {
                ...
                const hasRetryLogic = url.includes('/api/v1/connections/') || url.includes('/api/v1/pipelines/') || url.includes('/api/v1/monitoring/') || url.includes('/api/v1/audit-logs');
...
//# sourceMappingURL=_c2867126._.js.map