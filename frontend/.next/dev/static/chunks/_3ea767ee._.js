...
"[project]/app/errors/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ErrorsPage() {
    ...
    const { alerts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ErrorsPage.useAppSelector": (state)=>state.alerts
    }["ErrorsPage.useAppSelector"]);
    const { connections } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ErrorsPage.useAppSelector": (state)=>state.connections
    }["ErrorsPage.useAppSelector"]);
    const { pipelines } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ErrorsPage.useAppSelector": (state)=>state.pipelines
    }["ErrorsPage.useAppSelector"]);
    const { events } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ErrorsPage.useAppSelector": (state)=>state.monitoring
    }["ErrorsPage.useAppSelector"]);
    const [errorFilter, setErrorFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    const [selectedError, setSelectedError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Fetch data on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ErrorsPage.useEffect": ()=>{
    ...
    const dataQualityIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ErrorsPage.useMemo[dataQualityIssues]": ()=>{
            const issues = [];
            // Group failed events by table
            const failedByTable = {};
            events.filter({
                "ErrorsPage.useMemo[dataQualityIssues]": (e)=>e.status === 'failed' || e.status === 'error'
            }["ErrorsPage.useMemo[dataQualityIssues]"]).forEach({
                "ErrorsPage.useMemo[dataQualityIssues]": (e)=>{
                    if (e.table_name) {
                        failedByTable[e.table_name] = (failedByTable[e.table_name] || 0) + 1;
                    }
                }
            }["ErrorsPage.useMemo[dataQualityIssues]"]);
            Object.entries(failedByTable).forEach({
                "ErrorsPage.useMemo[dataQualityIssues]": ([table, count])=>{
                    const severity = count > 100 ? 'critical' : count > 50 ? 'high' : count > 20 ? 'medium' : 'low';
                    const latestEvent = events.filter({
                        "ErrorsPage.useMemo[dataQualityIssues]": (e)=>e.table_name === table && (e.status === 'failed' || e.status === 'error')
                    }["ErrorsPage.useMemo[dataQualityIssues]"]).sort({
                        "ErrorsPage.useMemo[dataQualityIssues]": (a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()
                    }["ErrorsPage.useMemo[dataQualityIssues]"])[0];
                    issues.push({
                        id: `dq_${table}`,
                        table,
                        column: 'replication',
                        ...
                        count,
                        severity,
                        lastDetected: latestEvent ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(latestEvent.created_at), {
                            addSuffix: true
                        }) : 'Unknown'
                    });
                }
            ...
            return issues.sort({
                "ErrorsPage.useMemo[dataQualityIssues]": (a, b)=>{
                    const severityOrder = {
                        critical: 4,
                        high: 3,
                        medium: 2,
    ...
    const filteredErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ErrorsPage.useMemo[filteredErrors]": ()=>{
            if (errorFilter === "all") return alerts;
            return alerts.filter({
                "ErrorsPage.useMemo[filteredErrors]": (e)=>e.status === errorFilter
            }["ErrorsPage.useMemo[filteredErrors]"]);
        }
    }["ErrorsPage.useMemo[filteredErrors]"], [
        alerts,
                                ...
                                children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        ...
                                                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(error.timestamp), "yyyy-MM-dd HH:mm:ss")
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/errors/page.tsx",
                                                                        lineNumber: 245,
                                                                        columnNumber: 27
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(error.timestamp), {
                                                addSuffix: true
                                            })
                                        }, void 0, false, {
                                            fileName: "[project]/app/errors/page.tsx",
...
_s(ErrorsPage, "eutYognOgn1gZvX7ezBezPIh4JE=", false, function() {
    return [
...
_c = ErrorsPage;
var _c;
__turbopack_context__.k.register(_c, "ErrorsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_3ea767ee._.js.map