        ...
        "MonitoringPage.useMemo[eventStats]": ()=>{
            ...
            const stats = {
                ...
                insert: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.event_type === 'insert'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                update: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.event_type === 'update'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                delete: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.event_type === 'delete'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                success: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.status === 'applied' || e.status === 'success'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                failed: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.status === 'failed' || e.status === 'error'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                captured: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.status === 'captured'
                }["MonitoringPage.useMemo[eventStats]"]).length,
                pending: filteredEvents.filter({
                    "MonitoringPage.useMemo[eventStats]": (e)=>e.status === 'captured' || e.status === 'pending'
                }["MonitoringPage.useMemo[eventStats]"]).length,
            ...
            if (("TURBOPACK compile-time value", "development") === 'development' && filteredEvents.length > 0) {
                ...
                console.log('[Monitoring] Sample event statuses:', filteredEvents.slice(0, 5).map({
...
//# sourceMappingURL=_f790dc04._.js.map