...
function MonitoringPage() {
    ...
    const eventStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const stats = {
            ...
            insert: filteredEvents.filter((e)=>e.event_type === 'insert').length,
            update: filteredEvents.filter((e)=>e.event_type === 'update').length,
            delete: filteredEvents.filter((e)=>e.event_type === 'delete').length,
            success: filteredEvents.filter((e)=>e.status === 'applied' || e.status === 'success').length,
            failed: filteredEvents.filter((e)=>e.status === 'failed' || e.status === 'error').length,
            captured: filteredEvents.filter((e)=>e.status === 'captured').length,
            pending: filteredEvents.filter((e)=>e.status === 'captured' || e.status === 'pending').length,
        ...
        if (("TURBOPACK compile-time value", "development") === 'development' && filteredEvents.length > 0) {
            ...
            console.log('[Monitoring] Sample event statuses:', filteredEvents.slice(0, 5).map((e)=>({
                    id: e.id,
                    status: e.status
                })));
        }
...
//# sourceMappingURL=_d4a67bb5._.js.map